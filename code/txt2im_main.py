import argparse
import yaml
import txt2im_training
import txt2im_generating
import utils
import torch
...
if __name__ == '__main__':
    ...
    if args['db_type'] == 'flowers':
        transformations = transforms.Compose([transforms.Resize((224,224)),#transforms.Resize((64,64)),#transforms.Resize((224,224)),
                                              transforms.ToTensor()])
    ...
    txt2im_training.train(args, dataset, device)
    #txt2im_generating.generate(args, dataset, device)
