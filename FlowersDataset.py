...
from transformers import DeiTFeatureExtractor, BertTokenizer
import os
...
class ImageCaption102FlowersDataset(Dataset):
    def __init__(self, args, transform=None):
        ...
        self.BERT_tokenizer = BertTokenizer.from_pretrained(args.txt2im_model_args.encoder_args.name)
    ...
    def __getitem__(self, idx):
        ...
        labels = self.BERT_tokenizer(txt, padding="max_length", truncation=True,
                                     max_length=self.txt_max_len, return_tensors="pt").input_ids
        ...
        return im, pixel_values.squeeze(), torch.tensor(labels)
