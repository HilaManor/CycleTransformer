...
def train(args, dataset):
    ...
    txt2im_model = Text2Image(args.txt2im_model_args).to(device)
    im2txt_model = Image2Text(args.im2txt_model_args).to(device)
    ...
    txt2im_optimizer = torch.optim.Adam(txt2im_model.parameters(), lr=args.training_args.learning_rate)
    im2txt_optimizer = torch.optim.Adam(im2txt_model.parameters(), lr=args.training_args.learning_rate)
